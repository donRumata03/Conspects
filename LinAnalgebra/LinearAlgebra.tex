...
\begin{document}
    ...
    В случае аддитивной группы записываем нейтральный элемент как \textbb{0}, обратный - как $-x$.
    В случае мультипликативной - записываем нейтральный элемент как \textbb{1}, обратный - как $\frac{1}{x}$ или $x^{-1}$.
