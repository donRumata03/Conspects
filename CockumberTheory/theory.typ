...
#thm(name: "Количество элементов конечного поля")[
    $|F| = "char" F^n = p^n, p is "prime"$
]
#thm(name: "Единственность конечного поля")[
    Конечные поля равного размера изоморфны.
]
...
== Split fields (of a polynomial)

aka Поле разложения

#thm[
    For any polynomial there exists its splitting field with degree $<= (deg f)!$ over F.
]
#pr[
  …  
]
...
#rm[
    Многочлены от конечного количества переменных — область целостности, как и от бесконечного, так как для многочлена рассмотрим подкольцо используемых переменных. 
]
#thm[
    lk
]
...
#thm[
    Корни многочлена переводятся автоморфизмом в корни многочлена
]
Существуют поле p^n (поле разложения x^pn - x)
Показываем, что оно размера p^n, показали что оно единственно
Множественных корней нет по критерию gcd(f, f') = 1


btw: Теорема о Жордановой форме — это частный случай https://ru.wikipedia.org/wiki/%D0%A1%D1%82%D1%80%D1%83%D0%BA%D1%82%D1%83%D1%80%D0%BD%D0%B0%D1%8F_%D1%82%D0%B5%D0%BE%D1%80%D0%B5%D0%BC%D0%B0_%D0%B4%D0%BB%D1%8F_%D0%BA%D0%BE%D0%BD%D0%B5%D1%87%D0%BD%D0%BE%D0%BF%D0%BE%D1%80%D0%BE%D0%B6%D0%B4%D1%91%D0%BD%D0%BD%D1%8B%D1%85_%D0%BC%D0%BE%D0%B4%D1%83%D0%BB%D0%B5%D0%B9_%D0%BD%D0%B0%D0%B4_%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8F%D0%BC%D0%B8_%D0%B3%D0%BB%D0%B0%D0%B2%D0%BD%D1%8B%D1%85_%D0%B8%D0%B4%D0%B5%D0%B0%D0%BB%D0%BE%D0%B2


Полезная книжка, там можно что-нибудь поискать: Algebraic number theory

Интересная штука: Двойственность Понтрягина
