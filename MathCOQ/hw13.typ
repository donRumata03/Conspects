...
- Если $D equiv lambda x. E$ и оно было получено как абстракция, то для подвыражения $x$ есть тип в контексте $Gamma$, а для $E$ — доказательство в дереве выше.
$
